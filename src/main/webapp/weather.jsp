...
<body>
	<div class="page-header header-filter background-foto"
						...
						<div class="col-md-6 ml-auto mr-auto">
							...
							<div class="predicciones-fila">
								...
								<div id="carousel2" class="carousel slide prediccion"
									...
									</a> <a class="carousel-control-next" href="#carousel2"
								...
								<div id="carousel3" class="carousel slide prediccion"
									...
									<a class="carousel-control-prev" href="#carousel3"
										...
										class="carousel-control-prev-icon" aria-hidden="true"></span>
										<span class="sr-only">Previous</span>
									</a> <a class="carousel-control-next" href="#carousel3"
										role="button" data-slide="next"> <span
										class="carousel-control-next-icon" aria-hidden="true"></span>
										<span class="sr-only">Next</span>
									</a>
							...
							<div class="predicciones-fila">
								...
								<div id="carousel4" class="carousel slide prediccion"
									...
									<a class="carousel-control-prev" href="#carousel4"
										role="button" data-slide="prev"> <span
										class="carousel-control-prev-icon" aria-hidden="true"></span>
										<span class="sr-only">Previous</span>
									</a> <a class="carousel-control-next" href="#carousel4"
										role="button" data-slide="next"> <span
										class="carousel-control-next-icon" aria-hidden="true"></span>
										<span class="sr-only">Next</span>
									</a>
								...
								<div id="carousel5" class="carousel slide prediccion"
									...
									<a class="carousel-control-prev" href="#carousel5"
										role="button" data-slide="prev"> <span
										class="carousel-control-prev-icon" aria-hidden="true"></span>
										<span class="sr-only">Previous</span>
									</a> <a class="carousel-control-next" href="#carousel5"
										role="button" data-slide="next"> <span
										class="carousel-control-next-icon" aria-hidden="true"></span>
										<span class="sr-only">Next</span>
									</a>
